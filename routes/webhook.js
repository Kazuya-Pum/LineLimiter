...
function handleEvent(event) {
    if (event.type === 'follow') {
        ...
        const userSchema = 'CREATE SCHEMA ' + event.source.userId + ' CREATE TABLE food (id int2 PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, name varchar(20) NOT NULL, limit_day date NOT NULL, image_url text, place varchar(40), memo varchar(100), category varchar(20), ctime timestamp default CURRENT_TIMESTAMP)';
